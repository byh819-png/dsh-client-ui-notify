...
export declare const zh: {
    ...
    'notify.systemNotify': string;
    'notify.system.answerComplete': string;
    'notify.system.authRequired': string;
    'notify.system.granted': string;
    'notify.system.denied': string;
    'notify.system.unsupported': string;
    ...
    'notify.toast.answerComplete': string;
    'notify.toast.authRequired': string;
    'notify.toast.close': string;
